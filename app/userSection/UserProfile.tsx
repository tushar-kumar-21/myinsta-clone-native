...
import BottomSheetSettings from './BottomSheet';
...
const UserProfile = () => {
    ...
    return (
        <>
            {/* <TouchableOpacity style={styles.bottomSheetToggle} onPress={handleBottomSheetToggle}>
                <Text style={styles.bottomSheetToggleText}>Open Bottom Sheet</Text>
            </TouchableOpacity> */}
            <FlatList
                ListHeaderComponent={
                    <>
            ...
            />
            {/* Render bottom sheet here */}
            {/* {bottomSheetVisible && <BottomSheetSettings />} */}
